...
const Breadcrumb = ({
  ...
  return (
    <div className="overflow-hidden pt-28">
      <div className="bg-background-hover">
                ...
                {breadcrumbItems.map((item, index) => {
                  ...
                  return (
                    <li key={index} className="flex items-center">
                      {isLast ? (
                        <span
                          className="font-medium text-custom-sm text-heading"
                          aria-current="page"
                        >
                          {item.label}
                        </span>
                        ...
                        <>
                          <Link
                            href={item.href}
                            className="text-text transition-colors text-custom-sm hover:text-primary"
                          >
                            {item.label}
                          </Link>
                          <span className="flex items-center mx-1 text-text">
                            {separator}
                          </span>
                        </>
                      )}
