      ...
      <div className="px-6 mx-auto max-w-7xl sm:px-6 xl:px-4 md:px-8 md:py-8 xl:py-12 sm">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-white rounded-xl dark:bg-[#18181b] border border-gray-200 dark:border-gray-800">
              <h2 className="mb-4 text-xl font-semibold text-heading">اختر طريقة الدفع</h2>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xs text-text mt-1">روابط الدفع + Apple Pay</div>
                  </div>
                </button>
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xs text-text mt-1">بطاقات دولية</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <p className="text-sm text-center text-text">
              🔒 الدفع آمن ومشفّر بواسطة {selectedProvider === "tap" ? "Tap Payments" : selectedProvider === "telr" ? "Telr" : "Stripe"}
            </p>
